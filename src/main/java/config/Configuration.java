...
public final class Configuration {
	 ...
	 * graded.
	 * 
	 * @param <T> the type of the {@link ListInterface}
	 * @return the {@link ListInterface} you want graded
	 */
	 ...
	 * graded.
	 * 
	 * @return the {@link MazeBuilderTest} you want to be graded
	 */
	public static MazeBuilder getMazeBuilder() {
		return new BasicMazeBuilder();
	}

	/**
	 * Given a {@link Maze}, returns a new instance of the {@link MazeSolution} that
	 * you want us to use to test your implementation.
	 * 
